...
quantity: ${this.quantity}`;
  ...
  buy(quantity) {
    ...
    const sumu = quantity * this.price;
...
try {
  console.group();
  const product = new Product("Aple", 7.65, "$", 17);
  console.log(product);
  console.log(product.information());
  console.log(product.buy(6));
  console.log(product.information());
  ...
  const physicalProduct = new PhysicalProduct("Banana", 3, "$", 90, 11);
  console.log(physicalProduct);
  console.log(physicalProduct.information());
  console.log(physicalProduct.buy(89));
  console.log(physicalProduct.information());
  console.groupEnd();
  ...
  const virtualProduct = new VirtualProduct("Memory", 120, "$", 30, 160);
  console.log(virtualProduct);
  console.log(virtualProduct.information());
  console.log(virtualProduct.buy(20));
  console.log(virtualProduct.information());
  console.groupEnd();
} catch (error) {
  console.log(error.message);
